    ...
    return (
        <div>
            ...
            <div className="container ">
                ...
                <Card style={{ width: '50rem', height: '42.8rem', padding: '1.5rem' }} className="card-class">
                    <form onSubmit={submitHandler}>
                        ...
                        <div className="form-group">
                            ...
                            <textarea id="summary" name="summary" className="form-control" placeholder="Enter summary" value={summary} onChange={(e) => dispatch({ type: 'summary', value: e.target.value })} rows="2" cols="50">
                        ...
                        <div className="form-group">
                            ...
                            <textarea id="content" name="content" className="form-control" placeholder="Enter Content" value={content} onChange={(e) => dispatch({ type: 'content', value: e.target.value })} rows="6" cols="50">
